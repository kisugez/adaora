	...
	return (
		<header
			className={`sticky top-0 z-50 w-full border-b backdrop-blur transition-all duration-300 ${
				scrolled
					? "bg-white/95 supports-[backdrop-filter]:bg-white/60 shadow-sm"
					: "bg-white"
			}`}
		>
			<div className="container flex h-16 items-center justify-between">
				<div className="flex items-center gap-2">
					...
					<div className="w-16 h-16"> {/* Increased size */}
						<Image
							src="/hand-drawn-one-line-art-illustration_23-2149286322-removebg-preview (1).webp" // Replace with the actual logo path
							alt="Adaora Logo"
					...
					<Link href="/" className="flex items-center">
						<span className="text-2xl font-bold uppercase text-gray-600">
							Adaora
						</span>
					</Link>
				</div>
				...
				<div className="flex items-center gap-4">
					...
					<Button className="hidden md:flex bg-brown-700 hover:bg-brown-800">
						Subscribe
					</Button>
			...
			{isMenuOpen && (
				...
				>
					<nav className="container flex flex-col gap-4">
						...
						<Button className="w-full bg-brown-700 hover:bg-brown-800 mt-2">
							Subscribe
						</Button>
					</nav>
				</motion.div>
